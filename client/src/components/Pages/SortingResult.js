                    ...
                    <table className="table" style={{ width: 'auto' }}>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            {sortingResult.firings ?
                              (abbreviateSha1Path(sortingResult.firings + '/firings.mda', { canDownload: false })) :
                              <span>None</span>
                            }
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            {sortingResult.consoleOut ?
                              (abbreviateSha1Path(sortingResult.consoleOut + '/stdout.txt', { canDownload: false })) :
                              <span>None</span>
                            }
                          </td>
                        </tr>
                        ...
                        <tr>
                          <th>Timed out</th>
                          <td>
                            {sortingResult.timedOut ? 'yes' : 'no'}
                          </td>
                        </tr>
                        <tr>
                          <th>Start time</th>
                          <td>
                            {format_date(sortingResult.startTime)}
                          </td>
                        </tr>
                        <tr>
                          <th>End time</th>
                          <td>
                            {format_date(sortingResult.endTime)}
                          </td>
                        </tr>
                      </tbody>
                    </table>
...
function format_date(x) {
  return (new Date(x)).toLocaleString('en-US', { year: 'numeric', month: 'short', day: 'numeric', hour: 'numeric', minute: 'numeric', second: 'numeric' });
}
